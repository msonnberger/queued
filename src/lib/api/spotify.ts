...
export type SimplifiedShowObject = ShowBase & object;
...
export type SimplifiedAudiobookObject = AudiobookBase & object;
 ...
 *
 */
export function putMeShows(ids: string, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
    } | {
        status: 401;
 ...
 *
 */
export function deleteMeShows(ids: string, { market }: {
    market?: string;
} = {}, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
 ...
 *
 */
export function getMeTopByType($type: string, { timeRange, limit, offset }: {
    timeRange?: string;
    limit?: number;
    offset?: number;
} = {}, opts?: Oazapfts.RequestOpts) {
    ...
    }>(`/me/top/${encodeURIComponent($type)}${QS.query(QS.explode({
 ...
 *
 */
export function putPlaylistsByPlaylistIdImages(playlistId: string, opts?: Oazapfts.RequestOpts) {
    return oazapfts.ok(oazapfts.fetchJson<{
        status: 200;
    } | {
        status: 401;
