...
--
-- Name: queues queue_join_code_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."queues"
    ADD CONSTRAINT "queue_join_code_key" UNIQUE ("id");
...
--
-- Name: tracks tracks_qid_spotify_uri_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."tracks"
    ADD CONSTRAINT "tracks_qid_spotify_uri_key" UNIQUE ("qid", "spotify_uri");
...
ALTER TABLE ONLY "public"."votes"
    ADD CONSTRAINT "votes_pkey" PRIMARY KEY ("voter_id", "track_id");


--
-- Name: queues queues_owner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."queues"
    ADD CONSTRAINT "queues_owner_id_fkey" FOREIGN KEY ("owner_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;


--
-- Name: tracks tracks_qid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."tracks"
    ADD CONSTRAINT "tracks_qid_fkey" FOREIGN KEY ("qid") REFERENCES "public"."queues"("id") ON DELETE CASCADE;


--
-- Name: votes votes_track_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY "public"."votes"
    ADD CONSTRAINT "votes_track_id_fkey" FOREIGN KEY ("track_id") REFERENCES "public"."tracks"("id") ON DELETE CASCADE;


--
-- Name: queues Enable delete for users based on owner_id; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable delete for users based on owner_id" ON "public"."queues" FOR DELETE USING (("auth"."uid"() = "owner_id"));


--
-- Name: queues Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable insert for authenticated users only" ON "public"."queues" FOR INSERT TO "authenticated" WITH CHECK (true);


--
-- Name: queues Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: tracks Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: queues Enable update for users based on owner_id; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable update for users based on owner_id" ON "public"."queues" FOR UPDATE USING (("auth"."uid"() = "owner_id"));
